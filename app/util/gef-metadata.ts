...
export const measurementTextVariables = [
  ...
  },
  {
    ...
    descriptionNl: "Massa en geometrie van sondeerinstallatie, inclusief verankering",
    category: "equipment",
  ...
  },
  {
    ...
    standardizedCodes: [
      { code: "MMET", description: "Measured, surveying" },
      { code: "MDGP", description: "Measured, differential GPS" },
      { code: "MGOV", description: "Measured, other methods" },
      { code: "MH10", description: "Estimated, contour map 1:10.000" },
      { code: "MT25", description: "Estimated, Topographic map 1:25.000" },
      { code: "MT50", description: "Estimated, Topographic map 1:50.000" },
      {
        code: "MAHN",
        description: "Estimated, 'Actueel Hoogtebestand Nederland'",
      },
      { code: "MSOV", description: "Estimated, other methods" },
      { code: "MONB", description: "Estimated, unknown method" },
      { code: "MFIC", description: "Fictive value" },
    ],
  },
  {
    id: 43,
    ...
    standardizedCodes: [
      { code: "LMET", description: "Measured, surveying" },
      { code: "LGPS", description: "Measured, GPS" },
      { code: "LDGM", description: "Measured, diff. GPS, > 5 m" },
      { code: "LDGN", description: "Measured, diff. GPS, between 1 and 5 m" },
      { code: "LDGZ", description: "Measured, diff. GPS, < 1m" },
      { code: "LGOV", description: "Measured, other methods" },
      { code: "LT10", description: "Estimated, Topographic map 1:10.000" },
      { code: "LT25", description: "Estimated, Topographic map 1:25.000" },
      { code: "LT50", description: "Estimated, Topographic map 1:50.000" },
      { code: "LD01", description: "Estimated, detailed map 1:100" },
      { code: "LD02", description: "Estimated, detailed map 1:200" },
      { code: "LD05", description: "Estimated, detailed map 1:500" },
      { code: "LD10", description: "Estimated, detailed map 1:1000" },
      { code: "LD25", description: "Estimated, detailed map 1:2500" },
      { code: "LSOV", description: "Estimated, other methods" },
      { code: "LONB", description: "Estimated, method unknown" },
    ],
  },
  {
    id: 44,
